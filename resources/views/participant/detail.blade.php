...
<section class="content-header" >
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <label style="margin-bottom: 40px; margin-left:10px ">Assesse</label>
                </div>
                <div class="col-sm-8" >
            ...
            <div class="row">
                <table class="table text-center" id="tableParticipant" style="width:80%; margin-left:20px">
                    <thead>
                        <tr class="success">
                            <th>Nama</th>
                            <th>Email</th>
                    ...
                    <tbody id="tbody">
                        @if($method == "Manual")
                            <tr id="rowAssesse0" class="rowAssesse">
                                <td>{{ $assesse->name }}</td>
                                <td>{{ $assesse->email }}</td>
                                <td><span class='badge' style="background-color: #4fd6a2;">1</span></td>
                            ...
                            <tr>
                               ...
                               <div id="collapse0" class="panel-collapse collapse">
                                    <h3><span class='badge' >Assessor List</span><button id="0" class='btn addAssessor' style=" float: right;"><span class='badge' style="background-color: #4fd6a2;">Add Assessor</span></button></h3>
                ...
                <br><br><br><br>
                    <button style="float:right; margin-right:20px" id="finalize" class="btn btn-primary">Finalize</button>
                    <input name="object" type="hidden" id="object" value="{{ csrf_token() }}">
            </div>
    ...
    $("#save").on("click", function(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                html = html.concat('<thead><tr class="warning"><th>Name</th><th>Email</th><th>Relationship</th><th>Status</th><th>&nbsp;</th></tr></thead>');
