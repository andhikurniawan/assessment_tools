...
<div class="container-fluid">
        ...
        <h1 class="pull-right">
           <a class="btn btn-success pull-right" style="margin-top: -65px;" href="{{ route('competencyGroups.create') }}">Tambah Grup Kompetensi</a>
           </h1> 

        <div class ="container">
        <h3 style="margin-left: -16px;">Kelola Grup Kompetensi</h3> 
