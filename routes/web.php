...
Route::post("assessmentSession/update", "assessmentSessionController@editAssessment")->name("assessmentSession/update");
Route::post("assessmentSession/deleteModel", "assessmentSessionController@deleteModel")->name("assessmentSession/deleteModel");
Route::post("assessmentSession/deleteParticipant", "assessmentSessionController@deleteParticipant")->name("assessmentSession/deleteParticipant");
Route::post("assessmentSession/insertModel", "assessmentSessionController@insertModel")->name("assessmentSession/insertModel");
Route::post("assessmentSession/insertParticipant", "assessmentSessionController@insertParticipant")->name("assessmentSession/insertParticipant");
